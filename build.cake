...
// Define directories.
var buildDir = Directory("./src/DotNetCasClient.Memcached/bin/" + configuration);
var artifactDir = Directory("./artifacts");

// Define project metadata properties.
var projectOwners = "Apereo Foundation";
var projectName = "Apereo .NET CAS Client Memcached backed Proxy/Service Ticket Managers";
var projectDescription = "Memcached backed Proxy/Service Ticket Managers for the Apereo .NET CAS Client.";
...
Task("Version")
    ...
    .Does(() => 
    {
        ...
        var file = "./src/DotNetCasClient.Memcached/Properties/AutoGeneratedAssemblyInfo.cs";
...
Task("Restore-NuGet-Packages")
    ...
    .Does(() =>
    {
        NuGetRestore("./dotnet-cas-client-memcached.sln");
    });
...
Task("Build")
    ...
    .Does(() =>
    {
        ...
        {
        // Use MSBuild
        MSBuild("./dotnet-cas-client-memcached.sln", settings =>
            settings.SetConfiguration(configuration));
        }
        else
        {
        // Use XBuild
        XBuild("./dotnet-cas-client-memcached.sln", settings =>
            settings.SetConfiguration(configuration));
        }
    });
...
Task("Pack")
    ...
    .Does(() =>
    {
        ...
        NuGetPack("./src/DotNetCasClient.Memcached/DotNetCasClient.Memcached.nuspec", nuGetPackSettings);
    });
